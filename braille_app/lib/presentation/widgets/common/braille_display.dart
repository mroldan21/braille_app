...
class BrailleDisplay extends StatefulWidget {
  ...
  const BrailleDisplay({
    super.key, // ← SOLO super.key, eliminar key: key
    this.character,
    this.size = 200,
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.black.withOpacity(0.1), // ← Cambiar back to withOpacity
                blurRadius: 10,
  ...
  Widget _buildDot(bool isActive, int number) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: isActive ? widget.activeColor : widget.inactiveColor.withOpacity(0.3), // ← Cambiar back
        border: Border.all(
